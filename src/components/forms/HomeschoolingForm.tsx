...
const activities: Activity[] = [
  {
    ...
    fullDescription:
      "Horse riding builds balance, coordination, confidence, and responsibility while nurturing empathy and connection with animals. Our trained instructors ensure a safe and enriching experience for all skill levels.",
  ...
  },
  {
    ...
    fullDescription:
      "Mountain biking develops endurance, bike-handling skills, risk assessment, and resilience through guided trail riding. Students learn to navigate varying terrain while building physical fitness and mental toughness.",
  ...
  },
  {
    ...
    fullDescription:
      "Camping experiences teach independence, teamwork, planning, and self-reliance through immersive outdoor living. Students learn to set up camp, cook outdoors, and work together in nature.",
  ...
  },
  {
    ...
    fullDescription:
      "Our outdoor leadership programs focus on communication, decision-making, teamwork, and leadership through challenge-based activities. Students develop essential life skills in a supportive outdoor environment.",
  ...
  },
  {
    ...
    fullDescription:
      "Learners acquire practical skills such as shelter building, fire safety, knot-tying, and nature awareness. These hands-on experiences build confidence and self-sufficiency in outdoor environments.",
  ...
  },
  {
    ...
    fullDescription:
      "Archery enhances focus, patience, discipline, and hand-eye coordination in a safe and structured setting. Students learn proper technique while developing mental concentration and physical control.",
  ...
  },
  {
    ...
    fullDescription:
      "Orienteering teaches map reading, compass use, spatial awareness, and problem-solving while navigating natural environments. Students develop critical thinking skills and outdoor confidence.",
    ...
    <div className="min-h-screen bg-gradient-to-b from-forest-50 to-white">
      ...
      <div className="bg-forest-600 text-white py-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <Button variant="ghost" className="text-white hover:bg-forest-700 mb-6" onClick={() => window.history.back()}>
      ...
      <div className="container mx-auto max-w-6xl px-4 py-12">
        <div className="bg-accent/30 rounded-2xl p-8 mb-12">
          <p className="text-lg text-foreground leading-relaxed mb-6">
            Our Homeschooler Programs are designed to support families seeking meaningful, hands-on learning experiences
            beyond textbooks. These programs provide structured outdoor education that complements homeschooling
            curricula while fostering social interaction and real-world skill development.
          </p>
            ...
            <div>
              ...
              <ul className="space-y-2 text-muted-foreground">
                <li className="flex items-start gap-2">
                  ...
                  Curriculum-linked outdoor learning sessions across science, geography, physical education, and life
                  skills
                </li>
                <li className="flex items-start gap-2">
                  <CheckCircle className="w-5 h-5 text-primary shrink-0 mt-0.5" />
        ...
        <div className="mb-12">
          ...
          <p className="text-muted-foreground mb-6">
            Click on any activity to learn more about what's included and the benefits for your child.
          </p>
        ...
        <div className="bg-primary/5 rounded-xl p-6 mb-12">
          <p className="text-center text-muted-foreground italic">
            Ideal for families searching for <strong>homeschool outdoor programs in Nairobi</strong>,{" "}
            <strong>things homeschool children can do in Nairobi</strong>, and{" "}
            <strong>experiential learning for homeschoolers in Kenya</strong>.
          </p>
        </div>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="parentName" {...register("parentName")} placeholder="Your name" />
              ...
              <div>
                ...
                {errors.children && <p className="text-destructive text-sm mt-1">{errors.children.message}</p>}
              </div>
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="phone" {...register("phone")} placeholder="+254 114 705763" />
              ...
              <Button type="submit" className="w-full md:w-auto px-8 py-3" disabled={isSubmitting}>
