...
const defaultConfig: PartiesPageConfig = {
  ...
  metaDescription:
    "Host unforgettable birthday parties and celebrations at Karura Forest, at your venue, or as an overnight camping experience. Outdoor adventure parties for all ages.",
};
